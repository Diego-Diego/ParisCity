...
function SublimeIndex.OpenCharacterCreator()
    ...
    local main = RageUI.CreateMenu("", "Actions disponibles :", 1400, 40, "banner", 'ban');
    local subheritage = RageUI.CreateSubMenu(main, "", "HERITAGE :", 1400, 40, "banner", 'ban');
    local subvisage = RageUI.CreateSubMenu(main, "", "VISAGE :", 1400, 40, "banner", 'ban');
    local subtenues =  RageUI.CreateSubMenu(main, "", "TENUES :", 1400, 40, "banner", 'ban');
    local subvalid =  RageUI.CreateSubMenu(main, "", "VALID :", 1400, 40, "banner", 'ban');
    main.Closable = false
    ...
    while main do Citizen.Wait(0)
        ...
        RageUI.IsVisible(subvalid, function()
            if iIndex.tenues.Torso1 ~= 1 then
                ...
                RageUI.GoBack()
                ESX.ShowNotification("~r~Vous n'avez pas fait les modifications necessaires de votre personnage !")
            end
        end)
