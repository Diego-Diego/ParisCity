Locales['fr'] = {
  ...
  ['command_setfaction_faction'] = 'nom du faction',
  ['command_setfaction_grade'] = 'grade du faction',
  ['command_setfaction_invalid'] = 'le faction, le grade ou les deux sont invalides',
