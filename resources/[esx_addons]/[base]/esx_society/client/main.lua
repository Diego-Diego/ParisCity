			...
			ESX.OpenContext("right", elements, function(menu,element)
				...
				elseif element.value == "withdraw_society_money" then
					local elements = {
						...
						{icon = "fas fa-wallet", title = "Quantité", input = true, inputType = "number", inputPlaceholder = "Montant à retirer..", inputMin = 1, inputMax = 250000, name = "withdraw"},
				...
				elseif element.value == "deposit_money" then
					local elements = {
						...
						{icon = "fas fa-wallet", title = "Quantité", input = true, inputType = "number", inputPlaceholder = "quantité à déposé..", inputMin = 1, inputMax = 250000, name = "deposit"},
				...
				elseif element.value == "wash_money" then
					local elements = {
						...
						{icon = "fas fa-wallet", title = "Quantité", input = true, inputType = "number", inputPlaceholder = "Quantité à blanchir..", inputMin = 1, inputMax = 250000, name = "wash"},
	...
	ESX.TriggerServerCallback('esx_society:getJob', function(job)
		...
		ESX.OpenContext("right", elements, function(menu,element)
			local elements = {
				...
				{icon = "fas fa-wallet", title = "Quantité", input = true, inputType = "number", inputPlaceholder = "Montant pour changer de grade salaire..", inputMin = 1, inputMax = Config.MaxSalary, name = "gradesalary"},
				{icon = "fas fa-check", title = "Confirmer", value = "confirm"}
			}
