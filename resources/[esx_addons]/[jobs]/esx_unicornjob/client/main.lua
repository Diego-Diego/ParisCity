    ...
    if CurrentAction ~= nil then
      ...
      if IsControlJustReleased(0,  38) and IsJobTrue() then
        ...
        if CurrentAction == 'menu_vault' then
          exports.ox_inventory:openInventory('stash', {id = 'society_unicorn', owner = station})
        end

        if CurrentAction == 'menu_fridge' then
          exports.ox_inventory:openInventory('stash', {id = 'society_unicorn_fridge', owner = station})
        end
