TriggerEvent('esx_phone:registerNumber', 'mechanic', 'Client Mécano', true, true)
...
AddEventHandler('Ouvre:benny', function()
	...
	for i=1, #xPlayers, 1 do
		...
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'Norauto', '~r~Annonce', 'Norauto est ~g~ouvert !', 'CHAR_CARSITE3', 8)
	end
end)
...
AddEventHandler('Ferme:benny', function()
	...
	for i=1, #xPlayers, 1 do
		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'Norauto', '~r~Annonce', 'Plus aucun mécano est en ~r~ville~s~!', 'CHAR_CARSITE3', 8)
	end
end)
...
AddEventHandler('Recru:benny', function()
	...
	for i=1, #xPlayers, 1 do
		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'Norauto', '~r~Annonce', '~y~Recrutement en cours, rendez-vous au Norauto', 'CHAR_CARSITE3', 8)
	end
end)
...
RegisterCommand('meca', function(source, args, rawCommand)
  ...
  if xPlayer.job.name == "mechanic" then
      ...
      for i=1, #xPlayers, 1 do
          local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
          TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'Norauto', '~r~Annonce', ''..msg..'', 'CHAR_CARSITE3', 0)
      end
  else
