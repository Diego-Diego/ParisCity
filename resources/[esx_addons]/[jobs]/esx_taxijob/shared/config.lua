...
Config.MarkerType = {Cloakrooms = 25, ActionBoss = 25, Storage = 25, Garage = 25, DeleteVehicle = 25}
...
Config.spawnPoint = vector3(896.75, -153.16, 76.54)
Config.TaxiStations = {
	TAXI = {
		Cloakrooms = {
			vector3(888.56, -154.02, 76.88-0.98)
		},

		ActionBoss = {
			vector3(906.56, -150.92, 74.16-0.98)
		},

		Storage = {
			vector3(893.49, -162.30, 76.880-0.98)
		},
		Garage = {
			vector3(893.19, -146.47, 76.88-0.98),
		},
		DeleteVehicle = {
			vector3(896.67, -152.87, 76.56-0.98),
		},
	}
}
