...
TriggerEvent('esx_phone:registerNumber', 'gendarme', TranslateCap('alert_gendarme'), true, true)
TriggerEvent('esx_society:registerSociety', 'gendarme', 'Gendarme', 'society_gendarme', 'society_gendarme', 'society_gendarme', {
    type = 'private'
})

RegisterNetEvent('esx_gendarmejob:confiscatePlayerItem')
...
RegisterNetEvent('esx_gendarmejob:getStockItem')
...
RegisterNetEvent('esx_gendarmejob:putStockItems')
...
ESX.RegisterServerCallback('esx_gendarmejob:getOtherPlayerData', function(source, cb, target, notify)
...
ESX.RegisterServerCallback('esx_gendarmejob:storeNearbyVehicle', function(source, cb, plates)
	local xPlayer = ESX.GetPlayerFromId(source)
...
AddEventHandler('playerDropped', function()
	...
	if playerId then
		...
		if xPlayer and xPlayer.job.name == 'gendarme' then
			Wait(5000)
...
RegisterNetEvent('esx_gendarmejob:spawned')
...
RegisterNetEvent('esx_gendarmejob:forceBlip')
AddEventHandler('esx_gendarmejob:forceBlip', function()
	for _, xPlayer in pairs(ESX.GetExtendedPlayers('job', 'gendarme')) do
		TriggerClientEvent('esx_gendarmejob:updateBlip', xPlayer.source)
	end
end)
