...
Config.GendarmerieStations = {
	LSPD = {
		Blip = {
			Coords  = vector3(-451.21, 6010.008, 31.84),
			Sprite  = 78,
			Display = 4,
			Scale   = 1.0,
		},
		...
		Cloakrooms = {
			vector3(-451.38, 6010.11, 31.84)
		},

		Armories = {
			vector3(-426.96, 5996.87, 31.70)
		},

		Vehicles = {
			{
				Spawner = vector3(-450.02, 6003.05, 31.48),
				InsideShop = vector3(-475.38, 5988.60, 31.33),
				SpawnPoints = {
					{coords = vector3(-455.67, 6001.78, 31.33), heading = 85.03, radius = 6.0},
					{coords = vector3(-452.30, 5998.14, 31.33), heading = 85.03, radius = 6.0},
					{coords = vector3(-448.27, 5994.19, 31.33), heading = 87.87, radius = 6.0},
				}
			},
		},
		...
		Helicopters = {
			{
				Spawner = vector3(-479.05, 5984.36, 31.33),
				InsideShop = vector3(-475.38, 5988.60, 31.33),
				SpawnPoints = {
					{coords = vector3(-475.38, 5988.60, 31.33), heading = 314.64, radius = 10.0}
				}
			}
		},

		BossActions = {
			vector3(-433.37, 6004.25, 31.70)
		}
	}
}
...
Config.AuthorizedVehicles = {
	car = {
		recruit = {
			{model = 'sheriff', price = 0},
			{model = '308', price = 0},
		},
		officer = {
			{model = 'sheriff', price = 0},
			{model = 'police3', price = 0},
			{model = '5008gn', price = 0},
		},
		lieutenant = {
			{model = 'sheriff', price = 0},
			{model = 'police3', price = 0},
	...
	helicopter = {
		...
		officer = {},
		lieutenant = {
			{model = 'swift', props = {modLivery = 0}, price = 0}
		},
		sergeant = {
			{model = 'swift', props = {modLivery = 0}, price = 0}
		},
