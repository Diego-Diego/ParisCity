...
Config.Strings = {
	...
	PurchaseJerryCan = "Vous avez acheté un jerrycan pour ~g~$" .. Config.JerryCanCost,
	...
	RefillJerryCan = "Vous avez rempli le jerrican pour ",
	NotEnoughCashJerryCan = "~r~Pas assez d'argent pour remplir le jerrycan",
	JerryCanFull = "~g~Jerrican est plein",
	TotalCost = "Coût",
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Vous avez acheter une jerrican"
	Config.Strings.RefillJerryCan = "Tu as rempli le jerrican"
end
