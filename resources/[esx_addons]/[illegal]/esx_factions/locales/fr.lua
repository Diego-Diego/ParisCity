Locales['fr'] = {
	...
	['open_armory_boss'] = 'Appuyez sur ~INPUT_CONTEXT~ pour accéder à l\'armurerie haut gradés',
	-- Vehicles
	...
	['vehicle_unlocked'] = 'véhicule déverouillé~s~',
	...
	-- Notifications
	['you_confiscated'] = 'vous avez confisqué %sx~s~ %s~s~ à %s~s~',
	['got_confiscated'] = '%sx~s~ %s~s~ ont était confisqué par %s~s~',
	['you_confiscated_account'] = 'vous avez confisqué $%s~s~ (%s) à %s~s~',
	['got_confiscated_account'] = '$%s~s~ (%s) ont était confisqué par %s~s~',
	['you_confiscated_weapon'] = 'vous avez confisqué %s~s~ à %s~s~ avec ~o~%s~s~ balles',
	['got_confiscated_weapon'] = 'votre %s~s~ avec ~o~%s~s~ balles a était confisqué par %s~s~',
	['have_withdrawn'] = 'vous avez retiré %sx~s~ %s~s~',
	['have_deposited'] = 'vous avez déposé %sx~s~ %s~s~',
	-- Authorized Vehicles
