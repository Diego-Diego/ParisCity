// THIS IS FROM ANOTHER RESOURCE //
// https://github.com/KingRich-TLFRP/tfrploadingv2 //
...
if (!String.format) {
  ...
  var loadingWeights = [1/10, 4/10, 1.5/10, 3/10];
  ...
  var addEntry = function addEntry() {
      return function () {
          return handlers.onDataFileEntry({ name: 'Custom Features', isNew: true });
      };
  };
